...
CREATE TABLE NGUOIDUNG (
    IDNguoiDung NVARCHAR(30) PRIMARY KEY,
...
CREATE TABLE THONGTIN_ND (
    ...
    IDNguoiDung NVARCHAR(30) FOREIGN KEY REFERENCES NGUOIDUNG(IDNguoiDung)
)
go
...
CREATE TABLE VANCHUYEN (
    DonVi NVARCHAR(30) PRIMARY KEY,
    ThoiGianGD DATE
)
go
CREATE TABLE DONHANG (
    IDDonHang NVARCHAR(30) PRIMARY KEY,
    NgayDatHang DATE,
    TenSP NVARCHAR(40) FOREIGN KEY REFERENCES GIOHANG(TenSP),
    TenND NVARCHAR(20) FOREIGN KEY REFERENCES THONGTIN_ND(TenND),
    DonVi NVARCHAR(30) FOREIGN KEY REFERENCES VANCHUYEN(DonVi)
)
...
CREATE TABLE SHIPPER (
    ...
    SDT VARCHAR(10),
    IDDonHang NVARCHAR(30) FOREIGN KEY REFERENCES DONHANG(IDDonHang),
    MaDH NVARCHAR(20) FOREIGN KEY REFERENCES NOWSHIP(MaDH),
    DonVi NVARCHAR(30) FOREIGN KEY REFERENCES VANCHUYEN(DonVi)
)
